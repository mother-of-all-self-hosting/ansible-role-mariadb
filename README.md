...
Check [`defaults/main.yml`](defaults/main.yml) for the full list of supported options. Refer to [this page](docs/configuring-mariadb.md) for details about setting up the service with this role.
